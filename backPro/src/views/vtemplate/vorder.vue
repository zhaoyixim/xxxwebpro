<template>
   <div>
    <div class="n-layout-page-header">
      <n-card :bordered="false" title="中奖列表">
          滴滴答滴滴答
      </n-card>
    </div> 
...
<script lang="ts" setup>
  ...
  import { getOrderTableList,changeEditData } from "@/api/vtemp/lists";
  import { columns } from './vorder';
  ...
  const loadDataTable = async (res) => {
    return await getOrderTableList({ ...params, ...res });
  };
