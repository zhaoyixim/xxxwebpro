<template>
  ...
  <script lang="ts">
    ...
    import { editItemMatchData } from "@/api/vtemp/lists";
    export default defineComponent({
      name: 'classuidmatchEdit',
      components: {},
      ...
      setup(props,context) {
        ...
        const submitBtn = async() =>{
          ...
          let checkok = true
            ...
            let reb = await editItemMatchData(submitForm)
            if(reb){
        ...
        function openDrawer(items:Object) {
          ...
          itemData.data = items   
          state.formParams.item_id = items.item_id
          state.formParams.cuid = items.cuid
          state.formParams.card_N = items.card_N
          state.formParams.remain_N = items.remain_N      
          state.formParams.is_limit_N = items.is_limit_N
          formDataReadOnly.data.forEach(it=>{           
