...
create index p_orders_block_transaction_id_index
    on p_orders (block_transaction_id);

-- auto-generated definition
create table p_wallet_address
(
    id         int auto_increment
        primary key,
...
create index p_wallet_address_token_index
    on p_wallet_address (token);
